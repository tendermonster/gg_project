...
class TestPlayerClass(unittest.TestCase):
    ...
    def setUp(self):
        self.p0 = Player(None,0,Player.States.DO_NOTHING,p=100,c=100,b=100,randomize=False)
        self.p1 = Player(None,1,Player.States.DO_NOTHING,p=100,c=80,b=70,randomize=False)
    ...
    def testBuySellAvailabilityAfterInitialization(self):
        ...
        self.p2 = Player(None,2,Player.States.DO_NOTHING,p=70,c=80,b=20,randomize=False)
